        ...
        <>
            <header className="sticky top-0">
                ...
                <nav className="h-[3.5rem] sm:h-[4.5rem] w-full bg-slate-800 flex justify-between items-center px-3   sm:px-10 lg:px-5">
                    ...
                    <div className="h-full w-[%]  text-white/85 lg:flex items-center lg:gap-12 px-5 font-semibold hidden ">
                        ...
                        <a href="" className="hover:text-white"><i className="fa-regular fa-heart px-2 text-[1.2em]"></i>Favorites</a>
                       ...
                       <div>
                            {
                                ...
                                <i className="fa-regular fa-sun px-2 py-1 rounded-md text-yellow-400 text-[1.3em] sm:text-[1.5em] bg-white/5 hover:bg-white/20 duration-300" onClick={()=>{setdarkmode(!darkmode)}}></i>
                            }
                       </div>
                         ...
                         <div className="lg:hidden flex  mt-1">
                                {
                             hamberger ? <i className="fa-solid fa-bars text-[1.6em] sm:text-[1.7em] text-white" onClick={()=>{sethamberger(!hamberger)}}></i> :
                             <i className="fa-solid fa-xmark text-[1.6em] sm:text-[1.7em] text-white" onClick={()=>{sethamberger(!hamberger)}}></i>
                                }
