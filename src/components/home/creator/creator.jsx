            ...
            <section className=' h-[] w-full dark:bg-indigo-900 pb-10'>
                ...
                <div className='flex md:flex-row flex-col justify-center my-5  gap-10 px-5'>
                    ...
                    <div className='h-[] md:w-[60%] bg-slate-300 dark:bg-indigo-950  rounded-lg py-3'>
                        <p className='px-5 pt-4 text-[1.1em] text-center font-semibold text-black dark:text-white/90 sm:text-start'>Hi, I'm Deepak Modi, a passionate developer dedicated to making education more accessible and engaging for students. This website is a small step towards achieving that goal.</p>
                        ...
                        <div className='mt-10 px-5  flex flex-wrap md:justify-start justify-center gap-3'>
                                <a href="https://nishant-sharma-portfolio-yhsm.vercel.app/" className='bg-white/90 border border-indigo-500 hover:bg-white duration-300 text-indigo-500 py-2 px-2 rounded-md font-semibold flex items-center'>Visit My Portfolio <span className='px-1'><RiShareBoxFill /></span></a>

                                <a href="https://github.com/sharmanishant1612" className='bg-white/20 border border-indigo-500 text-indigo-500 dark:text-white py-2 px-3 rounded-md  flex items-center hover:bg-white/40 duration-300'><span className='px-1'><FiGithub /></span> GitHub </a>

                                <a href="http://www.linkedin.com/in/nishant-sharma-a2b15027b" className='bg-white/20 border border-indigo-500 text-indigo-500 dark:text-white py-2 px-3 rounded-md  flex items-center hover:bg-white/40 duration-300'><span className='px-1'><LuLinkedin /></span> LinkedIn </a>
